...
void startElection()
{
    ...
    int highestId = startingProcessId;
    ...
    while (current != NULL)
    {
        if (current->processId != startingProcessId)
        {
            if (current->processId > highestId)
            {
                printf("Process %d challenges Process %d\n", current->processId, startingProcessId);
                highestId = current->processId;
                coordinatorId = current->processId;
            }
            else
            {
                printf("Process %d ignores Process %d\n", current->processId, startingProcessId);
            }
        }
        current = current->next;
    }
...
int main()
{
    ...
    do
    {
        ...
        case 1:
        {
            ...
            // Randomly select one process as coordinator
